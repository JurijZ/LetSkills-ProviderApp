(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/http'), require('rxjs/add/operator/map'), require('rxjs/add/operator/catch'), require('rxjs/Rx'), require('rxjs/BehaviorSubject'), require('@angular/router'), require('jsrsasign'), require('rxjs/Observable'), require('rxjs/add/observable/throw'), require('rxjs/add/observable/interval'), require('rxjs/add/observable/timer')) :
...
var OidcSecurityService = (function () {
    ...
    OidcSecurityService.prototype.authorize = function () {
        ...
        var /** @type {?} */ state = this.oidcSecurityCommon.retrieve(this.oidcSecurityCommon.storage_auth_state_control);
        if (state === '') {
    ...
    OidcSecurityService.prototype.createAuthorizeUrl = function (nonce, state, authorization_endpoint) {
        ...
        var /** @type {?} */ params = new _angular_http.URLSearchParams(urlParts[1]);
        ...
        var /** @type {?} */ customParams = Object.assign({}, this.oidcSecurityCommon.retrieve(this.oidcSecurityCommon.storage_custom_request_params));
    ...
    OidcSecurityService.prototype.runTokenValidatation = function () {
        ...
        var /** @type {?} */ subscription = source.subscribe(function () {
            if (_this._isAuthorizedValue) {
                if (_this.oidcSecurityValidation.isTokenExpired(_this.oidcSecurityCommon.retrieve(_this.oidcSecurityCommon.storage_id_token), _this.authConfiguration.silent_renew_offset_in_seconds)) {
